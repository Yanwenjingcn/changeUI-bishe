 ...
 * 4、作业顺序：
 */
public class wbMinDeadlineFirst {
...
//        }
    ...
    public static void outputResult(Long diff, String resultPath) throws IOException {
        ...
        System.out.println("WB_MinDeadline:");
    ...
    static String wbResult = "wbMinDeadlineFirst.txt";
    ...
    public void runMakespan(String pathXML, String resultPath) throws Throwable {
        ...
        // 初始化作业映射
        wbMinDeadlineFirst fb = new wbMinDeadlineFirst();
