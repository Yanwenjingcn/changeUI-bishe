 ...
 */
public class WorkflowBasedEdition6 {
   ...
   // private static int taskTotal = 0;
     ...
     * 1、最早开始执行的任务优先调度（时间相同的********，如果有多个则随机选择一个）
     * 2、优先级高的先调度
     * 3、最早结束的优先调度
     * 这个都是在这里修改
     *
    ...
    private static void setDAGProperty(DAG dagmap) {
        //创建优先级
        int flag =dagmap.getDAGdeadline()/dagmap.gettasknumber();
        dagmap.setProperty(flag);
    }
...
//        }
    ...
    public static void outputResult(Long diff, String resultPath) throws IOException {
        ...
        System.out.println("WorkFlowBasedEdition6:");
    ...
    public void runMakespan(String pathXML, String resultPath) throws Throwable {
        ...
        // 初始化作业映射
        WorkflowBasedEdition6 fb = new WorkflowBasedEdition6();
