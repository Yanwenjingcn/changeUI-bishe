 ...
 *
 * 4、作业顺序：gap=50，deadline 最大的先开始
 */
public class WorkflowBasedEdition4 {
...
//        }
    ...
    public static void outputResult(Long diff, String resultPath) throws IOException {
        ...
        System.out.println("WorkFlowBasedEdition4:");
    ...
    public void runMakespan(String pathXML, String resultPath) throws Throwable {
        ...
        // 初始化作业映射
        WorkflowBasedEdition4 fb = new WorkflowBasedEdition4();
